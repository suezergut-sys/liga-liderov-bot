...
| 3. Начало Q3 | «Якорь» не повышает ставки поддержки, зарплаты растут на 10%, другие клиенты повышают ставки на 5%. Выбор: сохранить цель по прибыли и компенсировать отклонение либо пересмотреть цель. | Трудоёмкость и сроки «Вышки» недооценены вдвое. Выбор: остановить исходный проект либо продолжить за свой счёт. Подпись последствия зависит от PR и аванса бонуса в Q2. |

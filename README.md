...
- глобальное открытие этапа с задаваемой организатором длительностью от 1 до 1440 минут (по умолчанию 10 минут);
- принудительный выбор организатора за отстающую команду;
- панель готовности семи команд и журнал событий;
- компактный двухколоночный интерфейс организатора с разделением красных и синих команд;
- светло-зелёная индикация выполненных действий команды: подключения капитана, выбора решения, загрузки файла и успешной доставки;
